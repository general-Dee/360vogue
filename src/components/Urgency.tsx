    ...
    <section className="py-20 bg-gradient-to-r from-red-50 to-orange-50">
      <div className="container px-4 mx-auto">
        <div className="text-center mb-12">
          <motion.div animate={{ scale: [1, 1.05, 1] }} transition={{ repeat: Infinity, duration: 2, repeatType: 'reverse' }} className="inline-flex items-center gap-2 bg-red-600 text-white px-6 py-2 rounded-full mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <div className="bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition"><div className="flex items-center gap-3 mb-4"><AlertCircle className="w-6 h-6 text-red-600" /><h3 className="font-heading font-bold text-lg">Selling Fast</h3></div><p className="text-gray-700 mb-2">This Ankara sold out in 48 hours last time</p><div className="text-red-600 font-bold text-sm animate-pulse-slow">⚡ Only 4 yards remaining of bestseller</div></div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition"><TrendingUp className="w-6 h-6 text-vogue-gold mb-3" /><h3 className="font-heading font-bold text-lg mb-2">Low Stock Alert</h3><ul className="space-y-2 text-sm"><li className="flex items-center gap-2"><span className="w-2 h-2 bg-red-600 rounded-full"></span> French Lace — 3 sets left</li><li className="flex items-center gap-2"><span className="w-2 h-2 bg-orange-500 rounded-full"></span> Aso-Oke — 2 sets remaining</li><li className="flex items-center gap-2"><span className="w-2 h-2 bg-yellow-500 rounded-full"></span> George Wrapper — 5 pieces left</li></ul><div className="mt-4 text-center text-vogue-gold font-semibold text-sm">Order via WhatsApp to secure yours</div></div>
        </div>
      </div>
    </section>
  );
